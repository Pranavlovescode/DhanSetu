      ...
      <div className="container mx-auto py-8">
        <Card className="max-w-2xl mx-auto bg-black border-zinc-800">
          <CardHeader>
            ...
            <CardDescription>
              Send money to another Dhansetu user
            </CardDescription>
          </CardHeader>
              ...
              <div className="relative">
                <Dialog open={isSearchOpen} onOpenChange={setIsSearchOpen}>
                  <DialogTrigger asChild>
                    <Button
                      variant="outline"
                      className="w-full justify-between bg-black text-white hover:bg-white/20 border-zinc-800 hover:text-white"
                        ...
                        <CommandGroup className={"p-1"}>
                          {filteredUsers.map((user) => (
                            <CommandItem
                              ...
                              className="cursor-pointer bg-black hover:bg-white/20 data-[selected=true]:bg-white/20 group"
                            >
                              <div className="flex items-center gap-2 w-full">
                                ...
                                <div>
                                  <p className="font-medium text-white group-hover:text-white group-data-[selected=true]:text-white">
                                    {user.users.full_name}
                                  </p>
                                  <p className="text-sm text-gray-500 group-hover:text-gray-300 group-data-[selected=true]:text-gray-300">
                                    {user.users.email}
                                  </p>
                                </div>
                              </div>
