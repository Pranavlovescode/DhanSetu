...
import { MessageCircle, X, TrendingUp, DollarSign, Target, PieChart, Edit, Save, User, Briefcase, Shield, AlertTriangle } from "lucide-react";
      ...
      <div className="bg-black text-white min-h-screen">
        ...
        <div className="container md:max-w-6xl mx-auto pt-8 px-4 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400">Manage your investment preferences and track your portfolio</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <Card className="bg-zinc-900 border-zinc-700">
              <CardContent className="p-6">
                ...
                <p className="text-2xl font-bold text-white">₹{investmentProfile.totalInvested.toLocaleString()}</p>
            ...
            <Card className="bg-zinc-900 border-zinc-700">
              <CardContent className="p-6">
                ...
                <p className="text-2xl font-bold text-white">₹{investmentProfile.currentValue.toLocaleString()}</p>
                <p className="text-sm text-green-400">+₹{(investmentProfile.currentValue - investmentProfile.totalInvested).toLocaleString()}</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-zinc-900 border-zinc-700">
              <CardContent className="p-6">
                ...
                <p className="text-2xl font-bold text-green-400">+{investmentProfile.returns}%</p>
          ...
          <Tabs defaultValue="profile" className="space-y-6 ">
            <TabsList className="bg-zinc-900 border-zinc-700 text-white">
              <TabsTrigger value="profile" className="data-[state=active]:bg-zinc-700 data-[state=active]:text-white text-white">
                <User className="h-4 w-4 mr-2" />
                Investment Profile
              </TabsTrigger>
              <TabsTrigger value="goals" className="data-[state=active]:bg-zinc-700 data-[state=active]:text-white text-white">
                <Target className="h-4 w-4 mr-2" />
                Goals & Strategy
              </TabsTrigger>
              <TabsTrigger value="risk" className="data-[state=active]:bg-zinc-700 data-[state=active]:text-white text-white">
            ...
            <TabsContent value="profile">
              <Card className="bg-zinc-900 border-zinc-700">
                <CardHeader className="flex flex-row items-center justify-between">
                  <div>
                    <CardTitle className="text-white">Personal Investment Profile</CardTitle>
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => setInvestmentProfile({...investmentProfile, experience: value})}
                        disabled={!isEditing}
                      >
                        <SelectTrigger className="bg-zinc-800 border-zinc-600 text-white">
                          <SelectValue />
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => setInvestmentProfile({...investmentProfile, investmentGoals: value})}
                        disabled={!isEditing}
                      >
                        <SelectTrigger className="bg-zinc-800 border-zinc-600 text-white">
                          <SelectValue />
                        ...
                        <SelectContent className="bg-zinc-800 border-zinc-600">
                          <SelectItem value="retirement" className="text-white">Retirement Planning</SelectItem>
                          <SelectItem value="wealth" className="text-white">Wealth Building</SelectItem>
                          <SelectItem value="income" className="text-white">Regular Income</SelectItem>
                          <SelectItem value="education" className="text-white">Education Fund</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => setInvestmentProfile({...investmentProfile, timeHorizon: value})}
                        disabled={!isEditing}
                      >
                        <SelectTrigger className="bg-zinc-800 border-zinc-600 text-white">
                          <SelectValue />
                    ...
                    <div>
                      <Label className="text-white">Monthly Investment Amount (₹)</Label>
                      <Input
                        value={investmentProfile.monthlyInvestment}
                        onChange={(e) => setInvestmentProfile({...investmentProfile, monthlyInvestment: e.target.value})}
                        disabled={!isEditing}
                  ...
                  <div>
                    <Label className="text-white mb-3 block">Preferred Investment Sectors</Label>
                    <div className="flex flex-wrap gap-2">
                      {["technology", "healthcare", "finance", "energy", "consumer", "real-estate"].map((sector) => (
                        <Badge
                          key={sector}
                          variant={investmentProfile.preferredSectors.includes(sector) ? "default" : "outline"}
                          ...
                          onClick={() => {
                            if (!isEditing) return;
                            const sectors = investmentProfile.preferredSectors.includes(sector)
                              ? investmentProfile.preferredSectors.filter(s => s !== sector)
                              : [...investmentProfile.preferredSectors, sector];
                            setInvestmentProfile({...investmentProfile, preferredSectors: sectors});
                          }}
                        >
                          {sector}
                        </Badge>
            ...
            <TabsContent value="goals">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card className="bg-zinc-900 border-zinc-700">
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-400 mt-1">₹6,50,000 of ₹10,00,000</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400 mt-1">₹4,00,000 of ₹5,00,000</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400 mt-1">₹80,000 of ₹2,00,000</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-zinc-900 border-zinc-700">
                  <CardHeader>
                    <CardTitle className="text-white">Investment Strategy</CardTitle>
                    <CardDescription className="text-gray-400">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-center space-x-3">
                        <div className={`w-3 h-3 rounded-full ${riskColors[investmentProfile.riskTolerance]}`}></div>
                        <span className="text-white capitalize">{investmentProfile.riskTolerance} Risk Portfolio</span>
                      </div>
                      ...
                      <div className="space-y-3">
                        <div className="p-3 bg-zinc-800 rounded-lg">
                          <div className="flex justify-between items-center mb-1">
                            ...
                            <Badge variant="outline" className="border-yellow-600 text-yellow-400">Medium</Badge>
                          </div>
                          <p className="text-sm text-gray-400">Portfolio volatility due to market fluctuations</p>
                        </div>

                        <div className="p-3 bg-zinc-800 rounded-lg">
                          <div className="flex justify-between items-center mb-1">
                            <span className="text-white">Concentration Risk</span>
                            <Badge variant="outline" className="border-green-600 text-green-400">Low</Badge>
                          </div>
                          <p className="text-sm text-gray-400">Well-diversified across sectors and asset classes</p>
                        </div>
                        ...
                        <div className="p-3 bg-zinc-800 rounded-lg">
                          ...
                          <p className="text-sm text-gray-400">High liquidity investments with quick exit options</p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="space-y-3">
                        <div className="p-3 bg-zinc-800 rounded-lg">
                          ...
                          <p className="text-sm text-gray-400">
                            Spread investments across multiple asset classes and sectors
                          </p>
                        </div>

                        <div className="p-3 bg-zinc-800 rounded-lg">
                          <h4 className="text-white font-medium mb-2">Regular Review</h4>
                          <p className="text-sm text-gray-400">
